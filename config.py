...
# Metadata paths
# -----------------
cc3m_tsg_path = '/checkpoint/sgvaze/genecis_test/cc_tsg_3m.pt'                                                                      # Where to save/look for parsed scene graphs from CC3M
cc3m_deterministic_root_path = '/checkpoint/sgvaze/genecis_test/mined_triplets_1.6E6_4.8_thresh.pt'                                 # Where to save/look for mined training triplets from CC3M
...
# -----------------
log_dir = '/checkpo int/sgvaze/conditional_similarity/cc3m/tb_logs_v3'      # Tensorboard logging
